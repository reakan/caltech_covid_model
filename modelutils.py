...
def run_simulation(ndays,npeople,locations,loc_weights=None,init_locations=None,init_states=None,lunchtimes=None,testsperday=25,testdelay=2,testingpolicy='Random',quarantinelen=14,lambda_=1e3):
    """
